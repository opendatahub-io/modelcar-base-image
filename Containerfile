FROM --platform=$BUILDPLATFORM registry.access.redhat.com/ubi8/go-toolset:1.22.9-2.1740673425@sha256:25f2884bcf8ba92eca7613c8dbcbdfb3e4951db2875732b01486628d57623745 AS build-stage
ARG TARGETOS
ARG TARGETARCH
